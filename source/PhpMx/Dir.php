...
abstract class Dir
{
    ...
    static function create(string $path): ?bool
    {
        ...
        return log_add('dir', "create $path", function () use ($path) {
            if (!is_dir($path)) {
    ...
    static function remove(string $path, bool $recursive = false): ?bool
    {
        ...
        return log_add('dir', "remove $path", function () use ($path, $recursive) {
            if (is_dir($path)) {
    ...
    static function copy(string $path_from, string $path_to, bool $replace = false): ?bool
    {
        ...
        return log_add('dir', "copy $path_from to $path_to", function () use ($path_from, $path_to, $replace) {
    ...
    static function move(string $path_from, string $path_to): ?bool
    {
        ...
        return log_add('dir', "move $path_from to $path_to", function () use ($path_from, $path_to) {
